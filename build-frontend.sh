...
<head>
    ...
    <style>
        ...
        .alert-success {
            background: linear-gradient(135deg, rgba(75, 192, 192, 0.3), rgba(79, 172, 254, 0.3));
    ...
    <main class="container my-5">
        ...
        <div class="hero-section">
            <div class="card-body text-center py-5">
                ...
                <p class="lead mb-4" style="color: rgba(255, 255, 255, 0.8); font-size: 1.2rem;">
                    <i class="fas fa-chart-line me-2"></i>
                    Discover if your test results are statistically significant with professional-grade analytics
                </p>
                <div class="row text-center mt-4">
                    <div class="col-md-4">
                        <div class="d-flex align-items-center justify-content-center mb-2">
                            <i class="fas fa-calculator me-2" style="color: #667eea; font-size: 1.5rem;"></i>
                            <span style="color: rgba(255, 255, 255, 0.9); font-weight: 500;">Statistical Analysis</span>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="d-flex align-items-center justify-content-center mb-2">
                            <i class="fas fa-chart-bar me-2" style="color: #4facfe; font-size: 1.5rem;"></i>
                            <span style="color: rgba(255, 255, 255, 0.9); font-weight: 500;">Visual Charts</span>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="d-flex align-items-center justify-content-center mb-2">
                            <i class="fas fa-lightbulb me-2" style="color: #f093fb; font-size: 1.5rem;"></i>
                            ...
                            <div class="row mt-4">
                                    ...
                                    <div class="metric-card mb-3">
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-sm">
                                                <tbody>
                                                    <tr>
                                                        <td style="color: rgba(255, 255, 255, 0.8);">Absolute</td>
                                                        <td id="absolute-diff" class="text-end fw-bold">-</td>
                                                    </tr>
                                                    <tr>
                                                        <td style="color: rgba(255, 255, 255, 0.8);">Relative</td>
                                                        <td id="relative-diff" class="text-end fw-bold">-</td>
                                                    </tr>
                                                    <tr>
                                                        <td style="color: rgba(255, 255, 255, 0.8);">95% CI</td>
                                ...
                                <div class="col-md-6">
                                    <div class="metric-card mb-3">
                                        <div class="d-flex align-items-center justify-content-between mb-3">
                                            <h5 class="mb-0">
                                                <i class="fas fa-flask me-2" style="color: #f093fb;"></i>
                                                Statistical Tests
                                            </h5>
                                        </div>
                                        <div class="table-responsive">
                                            <table class="table table-sm">
                                                <tbody>
                                                    <tr>
                                                        <td style="color: rgba(255, 255, 255, 0.8);">Z-Score</td>
                                                        <td id="z-score" class="text-end fw-bold">-</td>
                                                    </tr>
                                                    <tr>
                                                        <td style="color: rgba(255, 255, 255, 0.8);">P-Value</td>
                                                        <td id="p-value" class="text-end fw-bold">-</td>
                                                    </tr>
                                                    <tr>
                                                        <td style="color: rgba(255, 255, 255, 0.8);">Effect Size</td>
